...
<div class="navbar-inner" style="margin-bottom: 0px !important">
  <div class="container-fluid">
    <!-- Brand and toggle get grouped for better mobile display -->
    <div class="navbar-header" style="margin-bottom: 0px !important">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
        ...
        <span class="icon-bar"></span>
            ...
            <div>
	  <img src="{{asset('images/admissionlogo.png')}}"  class="logo-style" style="height: 72px !important">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <ul class="nav navbar-nav navbar-right" style="margin-top: 10px; margin-left:28px;margin-bottom: 0px !important" >
