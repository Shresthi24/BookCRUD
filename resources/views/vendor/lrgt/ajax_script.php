    ...
    function initialize(){
        ...
        my_form.find(':input').each(function(){
           /*
            ...
            $(document).on('keyup', '#firstnamebrother1', function() {
             alert('ac');
    validate();
...
/*
$(document).on('keyup', '#firstnamebrother1,#lastnamebrother1,#agebrother1,#brotherdiv1,#brotherroll1', function() {
       validate();
});

$(document).on('keyup', '#firstnamebrother2,#lastnamebrother2,#agebrother2,#brotherdiv2,#brotherroll2', function() {
       validate();
});

$(document).on('keyup', '#firstnamebrother3,#lastnamebrother3,#agebrother3,#brotherdiv3,#brotherroll3', function() {
       validate();
});
*/
    function validate(){
